...
function initModels(sequelize) {
  ...
  review_cities.belongsTo(cities, { as: "city", foreignKey: "id_city" });
  ...
  users_trip_city.belongsTo(cities, { as: "city", foreignKey: "id_city" });
  ...
  review_hotels.belongsTo(review_hotels, { as: "id_hotel_review_hotel", foreignKey: "id_hotel" });
